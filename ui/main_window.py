...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.requestTableView = QtWidgets.QTableView(self.dockWidgetContents_2)
        self.requestTableView.setObjectName("requestTableView")
        self.horizontalLayout.addWidget(self.requestTableView)
