...
class Ui_InputDialog(object):
    def setupUi(self, InputDialog):
        ...
        InputDialog.resize(460, 121)
        self.verticalLayout = QtWidgets.QVBoxLayout(InputDialog)
        self.verticalLayout.setObjectName("verticalLayout")
        self.fieldsFormLayout = QtWidgets.QFormLayout()
        self.fieldsFormLayout.setSizeConstraint(QtWidgets.QLayout.SetDefaultConstraint)
        self.fieldsFormLayout.setFieldGrowthPolicy(QtWidgets.QFormLayout.ExpandingFieldsGrow)
        self.fieldsFormLayout.setRowWrapPolicy(QtWidgets.QFormLayout.DontWrapRows)
